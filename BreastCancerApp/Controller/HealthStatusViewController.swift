...
final class CardFlowLayout: UICollectionViewFlowLayout {
    ...
    override init() {
        super.init()
        register(CardBackgroundView.self,
...
extension HealthStatusViewController {
    ...
    private func registerCells() {
        ["ProfileHeaderCell", "HealthFieldCell",
         "HealthDateCell", "HealthDropdownCell"].forEach {
...
extension HealthStatusViewController: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView,
        ...
        case 2:
            ...
            cell.configure(title: "Date of diagnosis",
                           date: profile.diagnosisDate,
                           isEditing: isEditingProfile)
            addSeparator(to: cell)
            cell.onDateChanged = { [weak self] newDate in
                self?.profile.diagnosisDate = newDate
            }
            return cell
        ...
        case 4:
            let cell = collectionView.dequeueReusableCell(
                withReuseIdentifier: "HealthDateCell", for: indexPath) as! HealthDateCell
            cell.configure(title: "Date of Birth",
                           date: profile.dateOfBirth,
                           isEditing: isEditingProfile)
            addSeparator(to: cell)
            cell.onDateChanged = { [weak self] newDate in
                self?.profile.dateOfBirth = newDate
            }
            return cell
        ...
        default:
            let cell = collectionView.dequeueReusableCell(
                withReuseIdentifier: "HealthDropdownCell", for: indexPath) as! HealthDropdownCell
            cell.configure(title: "Treatment Phase",
                           value: profile.treatmentPhase.rawValue,
                           isEditing: isEditingProfile)
...
extension HealthStatusViewController {
    ...
    func showOptionsPopup(title: String,
                          options: [String],
                          selected: String,
        ...
        let vc = OptionsPopupViewController(
            ...
            selected: selected, brandPink: brandPink
        ) { [weak self] choice in
            onSelect(choice)
...
// MARK: - Image Picker
extension HealthStatusViewController: UIImagePickerControllerDelegate,
