...
class GuidedJournalViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // If no existing entry and no question provided, fetch today's question
        if existingEntry == nil && questionText.isEmpty {
            datasource.getTodaysQuestion { [weak self] question in
    ...
    func formattedCategoryTags(for question: GuidedReflectionQuestion) -> String {
        ...
        // Show special tag for Apple suggestions
