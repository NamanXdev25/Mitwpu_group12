...
//                
//                // ✅ Only consider appointments that are strictly in the future (after current moment)
...
//            for: indexPath
//        ) as! CareViewInsightsCell
//        // ✅ Assign delegate so cell can notify us on tap
//        cell.delegate = self
//        return cell
//    }
//    
...
//        ], toSection: .appointmentHeader)
//        
//        // Appointments - strictly future only (not today, not past)
//        if let closest = closestUpcomingAppointment() {
//            let dateFormatter = DateFormatter()
//            dateFormatter.dateFormat = "dd MMM yyyy"
//            
