...
//        )
//        
//        // Start timer to check appointments every minute
...
//                
//                // Only consider appointments that are strictly in the future
//                guard appointmentDateTime > now else { continue }
//                
//                // Track the closest future appointment
...
//        
//        // Appointments - closest upcoming appointment based on date+time
...
//    }
//    
//    // MARK: - Symptoms Helper
//    private func todaysLoggedSymptoms() -> [String] {
//        // Fetches today's logs from SymptomDataSource and returns unique symptom names.
//        // Returning [] triggers the empty state label in CareSymptomsCell.
//        let logs = SymptomDataSource.shared.getTodayLogs()
//        // Deduplicate by symptom name while preserving order
//        var seen = Set<String>()
//        return logs.compactMap { log in
//            guard !seen.contains(log.symptomName) else { return nil }
//            seen.insert(log.symptomName)
//            return log.symptomName
//        }
//    }
//    
//    // MARK: - Closest Appointment Helper
...
//        ], toSection: .exercise)
//        
//        // Symptoms — fetches real data; empty array shows empty state in cell
//        snapshot.appendItems([
//            CareItem(id: UUID(), type: .symptoms(
//                title: "Symptoms logged",
//                loggedSymptoms: todaysLoggedSymptoms()
//            ))
//        ], toSection: .symptoms)
//        
//        // Appointments Header
