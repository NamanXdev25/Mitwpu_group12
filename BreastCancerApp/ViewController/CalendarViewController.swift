...
class CalendarViewController: UIViewController {
    ...
    private func adjustBottomInset() {
        ...
        exercisesCollectionView.scrollIndicatorInsets.bottom = tabBarHeight + extraPadding
    }
    ...
    private func createLayout() -> UICollectionViewLayout {
        return UICollectionViewCompositionalLayout { [weak self] (sectionIndex, _) -> NSCollectionLayoutSection? in
            ...
            if sectionIndex == 0 {
                ...
                // Determine if this section (Missed or Done) has content
    ...
    // Helper to check if a header will actually have text
    private func shouldShowHeader(for section: Int) -> Bool {
        ...
        if ExerciseManager.shared.history[key] != nil {
            ...
            return section == 1 // "No exercises planned" header
        }
        return false
    }
    ...
    private func createCalendarSection() -> NSCollectionLayoutSection {
        let itemSize = NSCollectionLayoutSize(
            ...
            heightDimension: .estimated(350) // Reduced from 370 to pull list up slightly
        )
        ...
        // Reduced bottom inset to 8 to close gap between calendar and list
    ...
    private func createExercisesSection(hasItems: Bool, hasHeader: Bool) -> NSCollectionLayoutSection {
        // If no items and no header, make the section essentially invisible
        ...
        // Remove bottom padding if section is empty to prevent stacked spaces
...
extension CalendarViewController: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        if kind == UICollectionView.elementKindSectionHeader && (indexPath.section == 1 || indexPath.section == 2) {
            ...
            if ExerciseManager.shared.history[key] != nil {
                ...
                header.configure(status: indexPath.section == 1 ? "No exercises planned" : "")
            }
...
extension CalendarViewController: ExerciseCalendarCellDelegate {
    func calendarCell(_ cell: ExerciseCalendarCell, didSelectDate date: Date) {
        ...
        // Refresh layout because header visibility/sizes might have changed
