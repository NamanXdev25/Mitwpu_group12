...
//        
//        // Set profile image if provided, otherwise use a placeholder or keep existing
//        if let image = profileImage {
//            ProfileImageView.image = image
//        } else {
//            // Use a system placeholder image if no profile image is provided
//            ProfileImageView.image = UIImage(systemName: "ProfilePhoto")
//        }
//    }
//}
