...
class LineGraphView: UIView {
    ...
    override func awakeFromNib() {
        ...
        lineLayer.strokeColor = UIColor.systemPink.cgColor
    ...
    @objc private func handleTap(_ gesture: UITapGestureRecognizer) {
        ...
        if let index = closestIndex { showPopup(at: index) } else { hidePopup() }
    }
    ...
    private func showPopup(at index: Int) {
        ...
        popupView.center = CGPoint(x: targetX, y: point.y - (popupView.frame.height / 2) - 15)
    ...
    override func draw(_ rect: CGRect) {
        ...
        let maxValue = CGFloat(dataPoints.max() ?? 10)
        ...
        for (i, val) in dataPoints.enumerated() {
            ...
            dot.fillColor = UIColor.systemPink.cgColor
