...
class JournalCalendarCell: UICollectionViewCell {
    ...
    @IBOutlet var previousMonthButton: UIButton!
    ...
    @IBAction func headerToggleTapped(_: UIButton) {
...
extension JournalCalendarCell: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        guard let cell = collectionView.dequeueReusableCell(
            ...
            for: indexPath
        ) as? JournalCalendarDateCell else {
            fatalError("Expected JournalCalendarDateCell for reuse identifier 'JournalCalendarDateCell' at \(indexPath)")
        }
